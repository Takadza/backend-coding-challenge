...
const EncryptionServiceImpl_1 = require("./services/EncryptionServiceImpl");
const EncryptionSymbols_1 = require("./ioc/EncryptionSymbols");
...
exports.EncryptionModule = EncryptionModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [EncryptionSymbols_1.ENCRYPTION_SERVICE],
    })
], EncryptionModule);
